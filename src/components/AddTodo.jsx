  ...
  const options = [
    {
      ...
      label: (
        <div className="flex gap-3">
          <GoDotFill className="text-2xl text-[#ED4C5C]" /> Very High
        </div>
      ),
    },
    {
      ...
      label: (
        <div className="flex gap-3">
          <GoDotFill className="text-2xl text-[#F8A541]" /> High
        </div>
      ),
    },
    {
      ...
      label: (
        <div className="flex gap-3">
          <GoDotFill className="text-2xl text-[#00A790]" /> Medium
        </div>
      ),
    },
    {
      ...
      label: (
        <div className="flex gap-3">
          <GoDotFill className="text-2xl text-[#428BC1]" /> Low
        </div>
      ),
    },
    {
      ...
      label: (
        <div className="flex gap-3">
          <GoDotFill className="text-2xl text-[#8942C1]" /> Very Low
        </div>
      ),
    },
  ];
